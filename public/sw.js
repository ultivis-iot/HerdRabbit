const CACHE_NAME = "herd-rabbit-v1.2.3";
...
const APP_SHELL = [
  ...
  "/theme.js?v=1.2.3",
  "/app.js?v=1.2.3",
  "/vendor/simplewebauthn-browser.js?v=1.2.3",
  "/ansi.js?v=1.2.3",
  "/terminal-links.js?v=1.2.3",
  "/direct-terminal-input.js?v=1.2.3",
  "/terminal-connection.js?v=1.2.3",
  "/ui-model.js?v=1.2.3",
  "/key-combinations.js?v=1.2.3",
  "/pane-preference.js?v=1.2.3",
  "/browse-preference.js?v=1.2.3",
  "/workspace-preference.js?v=1.2.3",
  "/terminal-preference.js?v=1.2.3",
  "/completion-preference.js?v=1.2.3",
  "/input-history-preference.js?v=1.2.3",
  "/launch-session.js?v=1.2.3",
  "/push-notifications.js?v=1.2.3",
