const CACHE_NAME = "herd-rabbit-v1.2.5";
...
const APP_SHELL = [
  ...
  "/theme.js?v=1.2.5",
  "/app.js?v=1.2.5",
  "/vendor/simplewebauthn-browser.js?v=1.2.5",
  "/ansi.js?v=1.2.5",
  "/terminal-links.js?v=1.2.5",
  "/direct-terminal-input.js?v=1.2.5",
  "/terminal-connection.js?v=1.2.5",
  "/ui-model.js?v=1.2.5",
  "/key-combinations.js?v=1.2.5",
  "/pane-preference.js?v=1.2.5",
  "/browse-preference.js?v=1.2.5",
  "/workspace-preference.js?v=1.2.5",
  "/terminal-preference.js?v=1.2.5",
  "/completion-preference.js?v=1.2.5",
  "/input-history-preference.js?v=1.2.5",
  "/launch-session.js?v=1.2.5",
  "/push-notifications.js?v=1.2.5",
