const CACHE_NAME = "herd-rabbit-v1.2.2";
...
const APP_SHELL = [
  ...
  "/theme.js?v=1.2.2",
  "/app.js?v=1.2.2",
  "/vendor/simplewebauthn-browser.js?v=1.2.2",
  "/ansi.js?v=1.2.2",
  "/terminal-links.js?v=1.2.2",
  "/direct-terminal-input.js?v=1.2.2",
  "/terminal-connection.js?v=1.2.2",
  "/ui-model.js?v=1.2.2",
  "/key-combinations.js?v=1.2.2",
  "/pane-preference.js?v=1.2.2",
  "/browse-preference.js?v=1.2.2",
  "/workspace-preference.js?v=1.2.2",
  "/terminal-preference.js?v=1.2.2",
  "/completion-preference.js?v=1.2.2",
  "/input-history-preference.js?v=1.2.2",
  "/launch-session.js?v=1.2.2",
  "/push-notifications.js?v=1.2.2",
