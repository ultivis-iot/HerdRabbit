const CACHE_NAME = "herd-rabbit-v1.2.4";
...
const APP_SHELL = [
  ...
  "/theme.js?v=1.2.4",
  "/app.js?v=1.2.4",
  "/vendor/simplewebauthn-browser.js?v=1.2.4",
  "/ansi.js?v=1.2.4",
  "/terminal-links.js?v=1.2.4",
  "/direct-terminal-input.js?v=1.2.4",
  "/terminal-connection.js?v=1.2.4",
  "/ui-model.js?v=1.2.4",
  "/key-combinations.js?v=1.2.4",
  "/pane-preference.js?v=1.2.4",
  "/browse-preference.js?v=1.2.4",
  "/workspace-preference.js?v=1.2.4",
  "/terminal-preference.js?v=1.2.4",
  "/completion-preference.js?v=1.2.4",
  "/input-history-preference.js?v=1.2.4",
  "/launch-session.js?v=1.2.4",
  "/push-notifications.js?v=1.2.4",
