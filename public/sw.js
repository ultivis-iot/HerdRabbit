const CACHE_NAME = "herd-rabbit-v1.2.7";
...
const APP_SHELL = [
  ...
  "/theme.js?v=1.2.7",
  "/app.js?v=1.2.7",
  "/vendor/simplewebauthn-browser.js?v=1.2.7",
  "/ansi.js?v=1.2.7",
  "/terminal-links.js?v=1.2.7",
  "/direct-terminal-input.js?v=1.2.7",
  "/terminal-connection.js?v=1.2.7",
  "/ui-model.js?v=1.2.7",
  "/key-combinations.js?v=1.2.7",
  "/pane-preference.js?v=1.2.7",
  "/browse-preference.js?v=1.2.7",
  "/workspace-preference.js?v=1.2.7",
  "/terminal-preference.js?v=1.2.7",
  "/completion-preference.js?v=1.2.7",
  "/input-history-preference.js?v=1.2.7",
  "/launch-session.js?v=1.2.7",
  "/push-notifications.js?v=1.2.7",
