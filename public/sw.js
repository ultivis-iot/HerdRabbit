const CACHE_NAME = "herd-rabbit-v1.4.1";
...
const APP_SHELL = [
  ...
  "/theme.js?v=1.4.1",
  "/app.js?v=1.4.1",
  "/vendor/simplewebauthn-browser.js?v=1.4.1",
  "/ansi.js?v=1.4.1",
  "/terminal-links.js?v=1.4.1",
  "/direct-terminal-input.js?v=1.4.1",
  "/terminal-connection.js?v=1.4.1",
  "/ui-model.js?v=1.4.1",
  "/key-combinations.js?v=1.4.1",
  "/pane-preference.js?v=1.4.1",
  "/browse-preference.js?v=1.4.1",
  "/workspace-preference.js?v=1.4.1",
  "/terminal-preference.js?v=1.4.1",
  "/completion-preference.js?v=1.4.1",
  "/input-history-preference.js?v=1.4.1",
  "/launch-session.js?v=1.4.1",
  "/push-notifications.js?v=1.4.1",
