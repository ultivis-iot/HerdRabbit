const CACHE_NAME = "herd-rabbit-v1.2.6";
...
const APP_SHELL = [
  ...
  "/theme.js?v=1.2.6",
  "/app.js?v=1.2.6",
  "/vendor/simplewebauthn-browser.js?v=1.2.6",
  "/ansi.js?v=1.2.6",
  "/terminal-links.js?v=1.2.6",
  "/direct-terminal-input.js?v=1.2.6",
  "/terminal-connection.js?v=1.2.6",
  "/ui-model.js?v=1.2.6",
  "/key-combinations.js?v=1.2.6",
  "/pane-preference.js?v=1.2.6",
  "/browse-preference.js?v=1.2.6",
  "/workspace-preference.js?v=1.2.6",
  "/terminal-preference.js?v=1.2.6",
  "/completion-preference.js?v=1.2.6",
  "/input-history-preference.js?v=1.2.6",
  "/launch-session.js?v=1.2.6",
  "/push-notifications.js?v=1.2.6",
