const CACHE_NAME = "herd-rabbit-v1.2.8";
...
const APP_SHELL = [
  ...
  "/theme.js?v=1.2.8",
  "/app.js?v=1.2.8",
  "/vendor/simplewebauthn-browser.js?v=1.2.8",
  "/ansi.js?v=1.2.8",
  "/terminal-links.js?v=1.2.8",
  "/direct-terminal-input.js?v=1.2.8",
  "/terminal-connection.js?v=1.2.8",
  "/ui-model.js?v=1.2.8",
  "/key-combinations.js?v=1.2.8",
  "/pane-preference.js?v=1.2.8",
  "/browse-preference.js?v=1.2.8",
  "/workspace-preference.js?v=1.2.8",
  "/terminal-preference.js?v=1.2.8",
  "/completion-preference.js?v=1.2.8",
  "/input-history-preference.js?v=1.2.8",
  "/launch-session.js?v=1.2.8",
  "/push-notifications.js?v=1.2.8",
