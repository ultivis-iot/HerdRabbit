const CACHE_NAME = "herd-rabbit-v1.4.0";
...
const APP_SHELL = [
  ...
  "/theme.js?v=1.4.0",
  "/app.js?v=1.4.0",
  "/vendor/simplewebauthn-browser.js?v=1.4.0",
  "/ansi.js?v=1.4.0",
  "/terminal-links.js?v=1.4.0",
  "/direct-terminal-input.js?v=1.4.0",
  "/terminal-connection.js?v=1.4.0",
  "/ui-model.js?v=1.4.0",
  "/key-combinations.js?v=1.4.0",
  "/pane-preference.js?v=1.4.0",
  "/browse-preference.js?v=1.4.0",
  "/workspace-preference.js?v=1.4.0",
  "/terminal-preference.js?v=1.4.0",
  "/completion-preference.js?v=1.4.0",
  "/input-history-preference.js?v=1.4.0",
  "/launch-session.js?v=1.4.0",
  "/push-notifications.js?v=1.4.0",
