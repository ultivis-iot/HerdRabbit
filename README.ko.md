...
한 번 알린 내용은 만료시키지 않고 디스크에 남깁니다(`~/.config/herdr-bridge/announced.json`). 허브가 재시작했거나 leaf가 한동안 조용했다고 해서 사실이 아니게 되는 게 아니고, 정말 사라진 머신은 알아서 목록에서 빠집니다 — 후보는 제안되기 전에 항상 확인되기 때문입니다. 개수 상한이 있고, 가득 차면 가장 오래 아무 말이 없던 머신이 자리를 내줍니다.
