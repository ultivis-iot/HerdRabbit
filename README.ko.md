...
- 확인 후 세션 또는 프로젝트 종료
- 프로젝트와 세션 이름 변경
- 이미지·동영상·오디오·텍스트를 내려받지 않고 브라우저에서 바로 보기
