...
링크된 머신에서 아직 지원하지 않는 것: 파일 탐색, 그리고 프로젝트·탭 생성과 종료. 둘 다 알 수 없는 실패 대신 이유를 알리고 거절하며, UI에서도 제안하지 않습니다.
...
파일은 이 머신의 것입니다. 다른 머신의 HerdRabbit을 통한 파일 탐색은 아직 지원하지 않습니다. Files 탭은 이 머신만 보여주고, 다른 서버를 지정한 요청은 엉뚱한 곳에서 답하는 대신 거절합니다.
